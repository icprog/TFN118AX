...
#define TWI_MASTER_TIMEOUT_COUNTER_LOAD_VALUE (20000UL)
...
{
	 NRF_GPIO->PIN_CNF[TWI_MASTER_CONFIG_CLOCK_PIN_NUMBER] = 0x02;
	 NRF_GPIO->PIN_CNF[TWI_MASTER_CONFIG_DATA_PIN_NUMBER] = 0x02;
